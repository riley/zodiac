...
$url = "http://en.wikipedia.org/wiki/List_of_stars_in_Gemini";
...
if (isset($data[0])) {
	...
	foreach ($data[0]->find('tr') as $row) {
		...
		$mysqli->query("INSERT INTO stars SET name='$name', henry_draper='$henry_draper', hipparcos='$hipparcos', right_ascension='$right_ascension', declination='$declination', magnitude='$magnitude', distance='$distance',	spectral_class='$spectral_class', constellation='gemini'");
